...
player won(game *g) {
  ...
  player prev = (g->next==X) ? O : X;
  if (line(grid[0][0], grid[0][1], grid[0][2])==prev ||
      line(grid[1][0], grid[1][1], grid[1][2])==prev ||
      line(grid[2][0], grid[2][1], grid[2][2])==prev ||
      line(grid[2][0], grid[1][1], grid[0][2])==prev ||
      line(grid[0][0], grid[1][1], grid[2][2])==prev ||
      line(grid[0][1], grid[1][1], grid[2][1])==prev ||
      line(grid[0][0], grid[1][0], grid[2][0])==prev ||
      line(grid[0][2], grid[1][2], grid[2][2])==prev) return prev;
  return N;
}
